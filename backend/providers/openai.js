...
function buildSystemPrompt() {
  return [
    ...
    "・1回につき 1〜3 件のコメントを返す。",
    "・質問がなければ感想や相槌を返す。",
    "・1件は日本語で、50文字以内の口語。質問への回答に必要な場合は45文字程度まで使ってよい。",
    "・20文字程度の長い文章も10回に1回程度は混ぜてよいが、長文ばかりにならないようにする。",
    ...
    "",
    "【視聴者名について】",
    "name は、実際のネット配信のチャット欄にいそうなハンドルネームにする。",
    "単純な実名だけの名前（例: ゆうき、さくら、けんた、John、Mary）は避ける。",
    "ひらがな・カタカナ・英字・数字・_ を自然に混ぜる。例: neko_22、もちもち3、sora_cafe、夜更かし民、Rin5。",
    "同じ名前や似たパターンの繰り返しを避ける。name に viewer / 視聴者 は含めない。12文字以内にする。",
    "",
    "【出力形式】",
